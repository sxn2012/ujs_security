...
namespace FileManagement
{
    class Second_Verify
    {
        public static DateTime ExpiredDate = DateTime.Now;
        public static ArgumentException pic_e;
        public static Image img;
        public static Exception ex;
        public static bool IsEmailAddr(String emailaddr)//检测输入的字符串是否为合法email地址
        {
        ...
        public static Boolean SendMsg(String dest,String cont)
        {
            if (IsEmailAddr(dest)) return SendEmailMsg(dest, cont);
            else if (IsPhoneNum(dest)) return SendTextMsg(dest, cont);
            else return false;

        }


        public static Boolean SendTextMsg(String dest, String cont)
        {
            try
            {
                String commandOptions = dest + " " + cont;
                ProcessStartInfo processStartInfo = new ProcessStartInfo();
                processStartInfo.FileName = "SendMessage.exe";
        ...
        public static Boolean SendEmailMsg(String dest, String cont)
        {
            try
            {
                String commandOptions = dest + " " + cont;
